...
hi Cursor ctermfg=16 ctermbg=249 cterm=NONE guifg=#182227 guibg=#9ea7a6 gui=NONE
...
hi LineNr ctermfg=102 ctermbg=236 cterm=NONE guifg=#84898c guibg=#2a343a gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#252c31 guibg=#252c31 gui=NONE
hi MatchParen ctermfg=40 ctermbg=NONE cterm=underline guifg=#dda790 guibg=NONE gui=underline
hi StatusLine ctermfg=231 ctermbg=235 cterm=NONE guifg=#f0f0f0 guibg=#575e61 gui=bold
...
hi Search ctermfg=255 ctermbg=22 cterm=underline guifg=NONE guibg=NONE gui=underline
...
hi Keyword ctermfg=202 ctermbg=NONE cterm=NONE guifg=#dda790 guibg=NONE gui=NONE
...
hi Special ctermfg=153 ctermbg=NONE cterm=NONE guifg=#f0f0f0 guibg=NONE gui=NONE
...
hi String ctermfg=113 ctermbg=NONE cterm=NONE guifg=#8bb664 guibg=NONE gui=NONE
...
hi Type ctermfg=221 ctermbg=NONE cterm=NONE guifg=#b5d8f6 guibg=NONE gui=NONE
